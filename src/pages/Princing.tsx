...
const princingCard = [
  {
    img: IMAGE.princing_pic1,
    text: "MG\nFree User",
    price: "0",
    month: "/Month",
  },
  {
    img: IMAGE.princing_pic2,
    text: "MG\nSingle User",
    price: "Rs.400",
    month: "/Month",
  },
  {
    img: IMAGE.princing_pic3,
    text: "MG\nMax User",
    price: "Rs.3000",
    month: "/Month",
  },
                  ...
                  >
                    ...
                    <div className="pricing-price">
                      <ul className="pricing-features">
                        <li>
                          Review Your Question<span>$18</span>
                        </li>
                        <li>
                          Analysis of Your "I Have"<span>$22</span>
                        </li>
                        <li>
                          Work with Resources<span>$14</span>
                        </li>
                        <li>
                          Analysis of Your "I Have"<span>$18</span>
                        </li>
                      </ul>
