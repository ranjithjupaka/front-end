...
const bit_coin = [
  {
    img: IMAGE.image_coin5,
    name: "Bitcoin",
    text: "BTC/0.88%",
    price: "$77,503,50",
  },
  {
    img: IMAGE.image_coin6,
    name: "Ethereum",
    text: "ETH/0.79%",
    price: "$63,153,50",
  },
  {
    img: IMAGE.image_coin7,
    name: "Dollar",
    text: "USD/0.68%",
    price: "$33,115,50",
  },
  {
    img: IMAGE.image_coin8,
    name: "Tether",
    text: "USDT/0.61%",
    price: "$45,213,50",
  },
  {
    img: IMAGE.image_coin9,
    name: "BNB",
    text: "BNB/0.68%",
    price: "$27,253,50",
  },
  {
    img: IMAGE.image_coin10,
    name: "Cardano",
    text: "ADA/0.58%",
    price: "$42,613,50",
  },
  {
    img: IMAGE.image_coin11,
    name: "Dogecoin",
    text: "DOGE/0.75%",
    price: "$72,415,50",
  },
  {
    img: IMAGE.image_coin12,
    name: "Polygon",
    text: "MATIC/0.88%",
    price: "$65,418,50",
  },
                ...
                <div className="row">
                  {bit_coin.map((item, index) => (
                    <div className="col-lg-12" key={index}>
                      <div
                        className="crypto-box style-3 wow fadeInUp"
                        data-wow-delay="0.2s"
                      >
            ...
            <div className="col-lg-8">
              <div className="row">
                <div className="col-lg-6 col-md-12 m-b30">
                  <div
                    className="overlay-box style-1 bg-light-yellow wow fadeInUp"
                    data-wow-delay="1.8s"
                  >
                ...
                <div className="col-lg-6 m-b30">
                  <div
                    className="overlay-box style-1 bg-light-purple wow fadeInUp"
                    data-wow-delay="2.0s"
                  >
                    <div className="contant-box">
                      <div className="crypto-info">
                ...
                <div className="col-lg-12">
                  <div
                    className="overlay-box style-2 overlay-style-1 wow fadeInUp"
                    data-wow-delay="2.4s"
                    style={{ backgroundImage: `url(${IMAGE.background_bg4})` }}
                  >
                    <div className="contant-box text-center">
                      <h2
                        className="title wow fadeInUp text-center text-light"
                        data-wow-delay="0.4s"
                      >
                        Create your
                        <br />
                      ...
                      <Link to="/Login" className="btn-link lg">
