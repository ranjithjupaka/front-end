    ...
    <>
      <footer className="site-footer style-1 position-relative">
        <div
          ...
          style={{ backgroundImage: `url(${IMAGE.image_banner1})` }}
        >
              ...
              <div className="row align-items-center">
                <div className="col-lg-6">
                  <div className="widget wow fadeInUp" data-wow-delay="0.4s">
                    ...
                    <p>
                      Boost Your Profits with Algorithmic Trading Strategies.
                    </p>
                  </div>
                </div>
                <div className="col-lg-6">
                    ...
                    <form className="dzSubscribe ft-subscribe mb-4">
                      ...
                      <div className="input-group mb-0">
                        ...
                        <button
                          ...
                          value="Submit"
                          type="submit"
                          className="btn btn-primary style-2 text-primary two"
                        >
                        ...
                        <button
                          ...
                          name="submit"
                          type="submit"
                          className="btn btn-primary style-2 text-primary"
                        >
                          Subscribe
                        </button>
                      </div>
            ...
            <div className="row align-items-center">
              <div className="col-lg-6 col-md-12">
                <div className="footer-inner text-lg-start text-center ">
                  <p className="copyright-text wow fadeInUp">
                    Copyright 2023 by{" "}
                    <Link className="text-primary" to="/" target="_blank">
                      MarketGaruda.com
                    </Link>
                    . All rights Reserved
                  </p>
